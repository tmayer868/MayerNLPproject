...
struct node{
    ...
    void forward(){
        if(node_type == "add"){
            ...
            double new_der_2 = secon_deriv*(1/func_val) - first_deriv*first_deriv/(func_val*func_val);
            ...
            double new_der_2 = secon_deriv*cos(func_val) - first_deriv*first_deriv*new_val;
            ...
            double new_der_2 = secon_deriv*(1/sqrt(1-func_val*func_val)) + first_deriv*first_deriv*func_val/(pow(1-func_val*func_val,1.5));
            ...
            double new_der_2 = -secon_deriv*(sin(func_val)) - first_deriv*first_deriv*cos(func_val);
            ...
            double new_der_2 = secon_deriv*(1/(cos(func_val)*cos(func_val))) + first_deriv*first_deriv*(new_val/(cos(func_val)*cos(func_val))); 
            ...
            double new_der_2 = secon_deriv*(1/(1+func_val*func_val)) - first_deriv*2*first_deriv*func_val/(pow(func_val*func_val + 1,2));
